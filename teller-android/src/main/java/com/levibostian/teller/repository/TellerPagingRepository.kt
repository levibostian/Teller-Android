...
/**
 * [TellerRepository] that is designed specifically for paging.
 */
abstract class TellerPagingRepository<CACHE: RepositoryCache, PAGING_REQUIREMENTS: TellerPagingRepository.PagingRequirements, GET_CACHE_REQUIREMENTS: TellerRepository.GetCacheRequirements, FETCH_RESPONSE: DataSourceFetchResponse>(val firstPageRequirements: PAGING_REQUIREMENTS): TellerRepository<CACHE, GET_CACHE_REQUIREMENTS, FETCH_RESPONSE>() {
