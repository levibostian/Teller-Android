...
/**
 * Stub of [TellerRepository] used for integration testing purposes.
 */
internal class TellerRepositoryStub(private val sharedPreferences: SharedPreferences,
                                    ...
                                    teller: Teller): TellerRepository<String, TellerRepositoryStub.GetRequirements, String>(schedulersProvider, cacheAgeManager, refreshManager, taskExecutor, refreshManagerListener, teller) {
    ...
    data class GetRequirements(val param: String = ""): TellerRepository.GetCacheRequirements {
